...
class Window_1:
    def __init__(self, master):
        self.master = master
        self.master.title("School Management System By SHIVAM HARSH AND NITESH")
        ...
        self.Lbl_Title = Label(self.Frame, text = 'LOGIN MENU \n\nCREATED BY SHIVAM,HARSH,NITESH', font = ('arial',30,'bold'), bg = 'green', fg = 'Black')
    ...
    def Login(self):
        ...
        if (u == str('IIIT BH.') and p == str('admin')):
            self.__menu__()
        else:
